...
/**
 *  ReminderWeekly defines specific behavior in the weekly reminder mode. This class implements the
 ...
 *  alarms to have a maximum of 24 hours of snooze time. Same as other reminder types,ReminderWeekly
