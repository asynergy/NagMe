...
/**
 *  ReminderDaily defines specific behavior in the daily reminder mode. This class implements the
 ...
 *  alarms to have a maximum of 24 hours of snooze time. Same as other reminder types, ReminderDaily
