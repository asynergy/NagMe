 ...
 *  types, ReminderOneTime works closely with the RemindMe database. Functions, such as
 *  getReminderType(), getWeekdays(), getDateString(), and getWeekOfMonth() etc, are all
 *  modifying to or reading from the database. For ReminderOneTime, it requires the user to set date
